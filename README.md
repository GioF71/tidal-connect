...
Starting late november 2023, BubbleUpnp supports hires flac, see [here]([DNS_SERVER_LIST:-8.8.8.8 8.8.4.4](https://www.reddit.com/r/TIdaL/comments/184gcsq/bubbleupnp_android_app_now_supports_hires_flac/)). This is something that, from what I know, is not supported by this Tidal Connect application, and will probably never be.  

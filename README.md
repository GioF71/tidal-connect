...
Please note that support is limited to cover running costs for subscriptions to music services.
...
Another alternative, if you have a HiFi subscription and/or are ok with being limited to 16bit/44.1kHz, is using [Logitech Media Server](https://www.mysqueezebox.com/) and Squeezelite (you might use my [docker image for squeezelite](https://github.com/GioF71/squeezelite-docker)): you just need to register a mysqueezebox account, install and configure the Tidal, and Tidal will be available among your Apps in the LMS webapp. I would consider this solution to be quite reliable as it seems to have some support from Tidal. I use it frequently without any issue.  
